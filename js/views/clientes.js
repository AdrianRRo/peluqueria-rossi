import { $, esc, openModal, whatsapp, toast, confirmDialog, eur, fmtShort } from "../util.js?v=16";
import { listClients, upsertClient, deleteClient, listAppointments } from "../store.js?v=16";
