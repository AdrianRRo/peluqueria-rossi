import { $, $$, esc, eur, toast, confirmDialog, todayStr, fmtShort } from "../util.js?v=16";
import { listProducts, getProduct, listClients, createSale, listSales, deleteAppt, restoreStock, IVA } from "../store.js?v=16";
